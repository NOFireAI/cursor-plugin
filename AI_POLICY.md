# cursor-plugin AI Policy

AI-assisted development is welcome in cursor-plugin.
...
A contribution is judged as a contribution to cursor-plugin, not as AI output.
...
## AI does not relax cursor-plugin's engineering rules
...
cursor-plugin may be developed using interactive assistants as well as autonomous or unattended agents.
...
We welcome research involving cursor-plugin and AI-assisted software engineering, including:
...
If an experiment produces a genuinely useful improvement to cursor-plugin, we welcome it as a contribution.
